...
public class TC_0201 extends BaseDriver {
    ...
    public void test1() {
        ...
        actions.click(ReFirstName).build().perform();
        actions.keyDown(Keys.BACK_SPACE).keyDown(Keys.BACK_SPACE).keyDown(Keys.BACK_SPACE).keyDown(Keys.BACK_SPACE).keyDown(Keys.BACK_SPACE).keyDown(Keys.BACK_SPACE).keyUp(Keys.BACK_SPACE).sendKeys("Ali").build().perform();
        MyFunc.wait(1);


        WebElement ReSurname = driver.findElement(By.xpath("(//div [@class='inputs']/input)[2]"));
        actions.click(ReSurname).build().perform();
        actions.keyDown(Keys.BACK_SPACE).keyDown(Keys.BACK_SPACE).keyDown(Keys.BACK_SPACE).keyDown(Keys.BACK_SPACE).keyDown(Keys.BACK_SPACE).keyUp(Keys.BACK_SPACE).sendKeys("Demir").build().perform();
        MyFunc.wait(1);
